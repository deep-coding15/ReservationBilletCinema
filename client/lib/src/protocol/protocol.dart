...
import 'package:cinema_reservation_client/src/protocol/favori.dart' as _i5;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.Utilisateur) {
      return _i4.Utilisateur.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.Utilisateur?>()) {
      return (data != null ? _i4.Utilisateur.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i5.Favori>) {
      return (data as List).map((e) => deserialize<_i5.Favori>(e)).toList()
          as T;
    }
    if (t == List<dynamic>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Utilisateur') {
      return deserialize<_i4.Utilisateur>(data['data']);
    }
