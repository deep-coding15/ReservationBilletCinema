...
import 'utilisateurs/utilisateur.dart' as _i8;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.Utilisateur) {
      return _i8.Utilisateur.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i8.Utilisateur?>()) {
      return (data != null ? _i8.Utilisateur.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Utilisateur') {
      return deserialize<_i8.Utilisateur>(data['data']);
    }
