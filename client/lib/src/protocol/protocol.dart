...
import 'seances/seance.dart' as _i4;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.Seance) {
      return _i4.Seance.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.Seance?>()) {
      return (data != null ? _i4.Seance.fromJson(data) : null) as T;
    }
    if (t == List<String>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Seance') {
      return deserialize<_i4.Seance>(data['data']);
    }
