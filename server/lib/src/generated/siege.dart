...
import 'siege_statut.dart' as _i2;
import 'siege_state.dart' as _i3;
...
abstract class Siege implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  factory Siege({
    ...
    required _i2.SiegeStatut type,
    required _i2.SiegeStatut statut,
    required _i3.SiegeState state,
  }) = _SiegeImpl;
  ...
  factory Siege.fromJson(Map<String, dynamic> jsonSerialization) {
    return Siege(
      ...
      row: jsonSerialization['row'] as String,
      number: jsonSerialization['number'] as int,
      cinemaId: jsonSerialization['cinemaId'] as int,
      type: _i2.SiegeStatut.fromJson((jsonSerialization['type'] as String)),
      statut: _i2.SiegeStatut.fromJson((jsonSerialization['statut'] as String)),
      state: _i3.SiegeState.fromJson((jsonSerialization['state'] as String)),
    );
  }
  ...
  _i2.SiegeStatut type;

  _i2.SiegeStatut statut;

  _i3.SiegeState state;
...
class SiegeUpdateTable extends _i1.UpdateTable<SiegeTable> {
  ...
  _i1.ColumnValue<String, String> row(String value) => _i1.ColumnValue(
    table.row,
    value,
  );
  ...
  _i1.ColumnValue<_i2.SiegeStatut, _i2.SiegeStatut> type(
    _i2.SiegeStatut value,
  ) => _i1.ColumnValue(
    table.type,
    value,
  );

  _i1.ColumnValue<_i2.SiegeStatut, _i2.SiegeStatut> statut(
    _i2.SiegeStatut value,
  ) => _i1.ColumnValue(
    table.statut,
    value,
  ...
  _i1.ColumnValue<_i3.SiegeState, _i3.SiegeState> state(_i3.SiegeState value) =>
      _i1.ColumnValue(
        table.state,
        value,
      );
...
class SiegeTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnString row;

  late final _i1.ColumnInt number;

  late final _i1.ColumnInt cinemaId;

  late final _i1.ColumnEnum<_i2.SiegeStatut> type;

  late final _i1.ColumnEnum<_i2.SiegeStatut> statut;

  late final _i1.ColumnEnum<_i3.SiegeState> state;
