...
class UtilisateurUpdateTable extends _i1.UpdateTable<UtilisateurTable> {
  ...
  _i1.ColumnValue<String, String> mot_de_passe_hash(String value) =>
      _i1.ColumnValue(
        table.mot_de_passe_hash,
        value,
      );
...
class UtilisateurTable extends _i1.Table<int?> {
  UtilisateurTable({super.tableRelation}) : super(tableName: 'utilisateurs') {
    ...
    mot_de_passe_hash = _i1.ColumnString(
      'mot_de_passe_hash',
      this,
    );
  ...
  late final _i1.ColumnString mot_de_passe_hash;
