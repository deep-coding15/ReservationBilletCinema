...
import '../endpoints/admin_dashboard_endpoint.dart' as _i4;
import '../endpoints/admin_films_endpoint.dart' as _i5;
import '../endpoints/admin_reservations_endpoint.dart' as _i6;
import '../endpoints/admin_salles_endpoint.dart' as _i7;
import '../endpoints/admin_seances_endpoint.dart' as _i8;
import '../endpoints/admin_support_endpoint.dart' as _i9;
import '../endpoints/admin_users_endpoint.dart' as _i10;
...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    var endpoints = <String, _i1.Endpoint>{
      ...
      'adminDashboard': _i4.AdminDashboardEndpoint()
        ..initialize(
          server,
          'adminDashboard',
          null,
        ),
      'adminFilms': _i5.AdminFilmsEndpoint()
        ..initialize(
          server,
          'adminFilms',
          null,
        ),
      'adminReservations': _i6.AdminReservationsEndpoint()
        ..initialize(
          server,
          'adminReservations',
          null,
        ),
      'adminSalles': _i7.AdminSallesEndpoint()
        ..initialize(
          server,
          'adminSalles',
          null,
        ),
      'adminSeances': _i8.AdminSeancesEndpoint()
        ..initialize(
          server,
          'adminSeances',
          null,
        ),
      'adminSupport': _i9.AdminSupportEndpoint()
        ..initialize(
          server,
          'adminSupport',
          null,
        ),
      'adminUsers': _i10.AdminUsersEndpoint()
        ..initialize(
          server,
          'adminUsers',
          null,
    ...
    connectors['adminDashboard'] = _i1.EndpointConnector(
      name: 'adminDashboard',
          ...
          call:
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['adminDashboard'] as _i4.AdminDashboardEndpoint)
        ...
        'getFilms': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminFilms'] as _i5.AdminFilmsEndpoint)
                  .getFilms(session),
        ),
    ...
    connectors['adminReservations'] = _i1.EndpointConnector(
      name: 'adminReservations',
      endpoint: endpoints['adminReservations']!,
      methodConnectors: {
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  (endpoints['adminReservations']
                          as _i6.AdminReservationsEndpoint)
        ...
        'effectuerRemboursement': _i1.MethodConnector(
          name: 'effectuerRemboursement',
          params: {
            'id': _i1.ParameterDescription(
              name: 'id',
              type: _i1.getType<int>(),
    ...
    connectors['adminSalles'] = _i1.EndpointConnector(
      name: 'adminSalles',
      endpoint: endpoints['adminSalles']!,
      methodConnectors: {
        'getSalles': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminSalles'] as _i7.AdminSallesEndpoint)
                  .getSalles(session),
        ),
        ...
        'createSalle': _i1.MethodConnector(
          name: 'createSalle',
          params: {
            ...
            'codeSalle': _i1.ParameterDescription(
              name: 'codeSalle',
              type: _i1.getType<String>(),
              nullable: false,
            ),
            'capacite': _i1.ParameterDescription(
              name: 'capacite',
              type: _i1.getType<int>(),
              nullable: false,
            ),
            'equipements': _i1.ParameterDescription(
              name: 'equipements',
              ...
              (
                ...
                Map<String, dynamic> params,
                  ...
                  .createSalle(
                    ...
                    codeSalle: params['codeSalle'],
                    capacite: params['capacite'],
                    equipements: params['equipements'],
                  ),
        ),
        'updateSalle': _i1.MethodConnector(
          name: 'updateSalle',
          params: {
            'id': _i1.ParameterDescription(
              name: 'id',
        ...
        'deleteSalle': _i1.MethodConnector(
          name: 'deleteSalle',
          params: {
            'id': _i1.ParameterDescription(
              name: 'id',
        ...
        'getSeances': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminSeances'] as _i8.AdminSeancesEndpoint)
                  .getSeances(session),
        ),
    ...
    connectors['adminSupport'] = _i1.EndpointConnector(
      name: 'adminSupport',
      endpoint: endpoints['adminSupport']!,
      methodConnectors: {
        'getDemandesSupport': _i1.MethodConnector(
          name: 'getDemandesSupport',
          params: {},
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminSupport'] as _i9.AdminSupportEndpoint)
                  .getDemandesSupport(session),
        ),
        ...
        'getUtilisateurs': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['adminUsers'] as _i10.AdminUsersEndpoint)
