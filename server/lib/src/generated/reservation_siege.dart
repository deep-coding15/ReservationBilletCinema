...
import 'reservation_siege_statut.dart' as _i3;
import 'package:cinema_reservation_server/src/generated/protocol.dart' as _i4;
...
abstract class ReservationSiege
  ...
  _i3.ReservationSiegeStatut statut;

  final int? _reservationsReservationsiegesReservationsId;
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      if (_reservationsReservationsiegesReservationsId != null)
        '_reservationsReservationsiegesReservationsId':
            _reservationsReservationsiegesReservationsId,
    };
  }
  ...
  static ReservationSiegeInclude include({
    ...
    return ReservationSiegeInclude._(reservation: reservation);
  }
...
class _ReservationSiegeImpl extends ReservationSiege {
  ...
  ReservationSiege copyWith({
    ...
    return ReservationSiegeImplicit._(
      ...
      $_reservationsReservationsiegesReservationsId:
          this._reservationsReservationsiegesReservationsId,
    );
  }
}

class ReservationSiegeImplicit extends _ReservationSiegeImpl {
  ReservationSiegeImplicit._({
    int? id,
    required int reservationId,
    _i2.Reservation? reservation,
    required int siegeId,
    required _i3.ReservationSiegeStatut statut,
    int? $_reservationsReservationsiegesReservationsId,
  }) : _reservationsReservationsiegesReservationsId =
           $_reservationsReservationsiegesReservationsId,
       super(
         id: id,
  ...
  factory ReservationSiegeImplicit(
    ReservationSiege reservationSiege, {
    int? $_reservationsReservationsiegesReservationsId,
  }) {
    return ReservationSiegeImplicit._(
      id: reservationSiege.id,
      reservationId: reservationSiege.reservationId,
      reservation: reservationSiege.reservation,
      siegeId: reservationSiege.siegeId,
      statut: reservationSiege.statut,
      $_reservationsReservationsiegesReservationsId:
          $_reservationsReservationsiegesReservationsId,
    );
  }
...
class ReservationSiegeUpdateTable
  ...
  _i1.ColumnValue<_i3.ReservationSiegeStatut, _i3.ReservationSiegeStatut>
  statut(_i3.ReservationSiegeStatut value) => _i1.ColumnValue(
    table.statut,
    value,
  );

  _i1.ColumnValue<int, int> $_reservationsReservationsiegesReservationsId(
    int? value,
  ) => _i1.ColumnValue(
    table.$_reservationsReservationsiegesReservationsId,
    value,
  );
}
...
class ReservationSiegeTable extends _i1.Table<int?> {
  ReservationSiegeTable({super.tableRelation})
    : super(tableName: 'reservation_siege') {
    ...
    $_reservationsReservationsiegesReservationsId = _i1.ColumnInt(
      '_reservationsReservationsiegesReservationsId',
      this,
    );
  }
  ...
  late final _i1.ColumnEnum<_i3.ReservationSiegeStatut> statut;

  late final _i1.ColumnInt $_reservationsReservationsiegesReservationsId;
  ...
  _i2.ReservationTable get reservation {
    ...
    _reservation = _i1.createRelationTable(
      ...
      field: ReservationSiege.t.reservationId,
...
class ReservationSiegeInclude extends _i1.IncludeObject {
  ReservationSiegeInclude._({_i2.ReservationInclude? reservation}) {
  ...
  @override
  Map<String, _i1.Include?> get includes => {'reservation': _reservation};
...
class ReservationSiegeRepository {
  ...
  final attachRow = const ReservationSiegeAttachRowRepository._();
...
class ReservationSiegeAttachRowRepository {
  const ReservationSiegeAttachRowRepository._();

  /// Creates a relation between the given [ReservationSiege] and [Reservation]
  /// by setting the [ReservationSiege]'s foreign key `reservationId` to refer to the [Reservation].
  Future<void> reservation(
    ...
    var $reservationSiege = reservationSiege.copyWith(
      reservationId: reservation.id,
    );
    await session.db.updateRow<ReservationSiege>(
      $reservationSiege,
      columns: [ReservationSiege.t.reservationId],
      transaction: transaction,
    );
  }
}
