...
class ReservationUpdateTable extends _i1.UpdateTable<ReservationTable> {
  ...
  _i1.ColumnValue<int, int> utilisateur_id(int value) => _i1.ColumnValue(
    table.utilisateur_id,
    value,
  );

  _i1.ColumnValue<int, int> seance_id(int value) => _i1.ColumnValue(
    table.seance_id,
    value,
  );

  _i1.ColumnValue<DateTime, DateTime> date_reservation(DateTime? value) =>
      _i1.ColumnValue(
        table.date_reservation,
        value,
      );

  _i1.ColumnValue<double, double> montant_total(double value) =>
      _i1.ColumnValue(
        table.montant_total,
        value,
      );
...
class ReservationTable extends _i1.Table<int?> {
  ReservationTable({super.tableRelation}) : super(tableName: 'reservations') {
    ...
    utilisateur_id = _i1.ColumnInt(
      'utilisateur_id',
      this,
    );
    seance_id = _i1.ColumnInt(
      'seance_id',
      this,
    );
    date_reservation = _i1.ColumnDateTime(
      'date_reservation',
      this,
      hasDefault: true,
    );
    montant_total = _i1.ColumnDouble(
      'montant_total',
      this,
    );
  ...
  late final _i1.ColumnInt utilisateur_id;

  late final _i1.ColumnInt seance_id;

  late final _i1.ColumnDateTime date_reservation;

  late final _i1.ColumnDouble montant_total;
