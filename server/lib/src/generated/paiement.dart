...
import 'paiement_statut.dart' as _i2;
...
abstract class Paiement
  ...
  factory Paiement({
    ...
    required _i2.PaiementStatut statut,
  ...
  factory Paiement.fromJson(Map<String, dynamic> jsonSerialization) {
    return Paiement(
      ...
      statut: _i2.PaiementStatut.fromJson(
        (jsonSerialization['statut'] as String),
      ),
      transactionId: jsonSerialization['transactionId'] as String,
      datePaiement: _i1.DateTimeJsonExtension.fromJson(
        jsonSerialization['datePaiement'],
      ),
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'datePaiement': datePaiement.toJson(),
    };
  }
...
class PaiementUpdateTable extends _i1.UpdateTable<PaiementTable> {
  ...
  _i1.ColumnValue<_i2.PaiementStatut, _i2.PaiementStatut> statut(
    _i2.PaiementStatut value,
  ) => _i1.ColumnValue(
    table.statut,
    value,
  );
  ...
  _i1.ColumnValue<DateTime, DateTime> datePaiement(DateTime value) =>
      _i1.ColumnValue(
        table.datePaiement,
        value,
      );
...
class PaiementTable extends _i1.Table<int?> {
  PaiementTable({super.tableRelation}) : super(tableName: 'paiement') {
    ...
    datePaiement = _i1.ColumnDateTime(
      'datePaiement',
      this,
    );
  }
  ...
  late final _i1.ColumnEnum<_i2.PaiementStatut> statut;

  late final _i1.ColumnString transactionId;

  late final _i1.ColumnDateTime datePaiement;
