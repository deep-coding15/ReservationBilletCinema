...
import 'code_promo_statut.dart' as _i2;
...
abstract class CodePromo
  ...
  factory CodePromo({
    ...
    required _i2.CodePromoStatut statut,
  ...
  factory CodePromo.fromJson(Map<String, dynamic> jsonSerialization) {
    return CodePromo(
      ...
      pourcentage: (jsonSerialization['pourcentage'] as num).toDouble(),
      ...
      statut: _i2.CodePromoStatut.fromJson(
...
class CodePromoUpdateTable extends _i1.UpdateTable<CodePromoTable> {
  ...
  _i1.ColumnValue<double, double> pourcentage(double value) => _i1.ColumnValue(
    table.pourcentage,
    value,
  );
  ...
  _i1.ColumnValue<_i2.CodePromoStatut, _i2.CodePromoStatut> statut(
    _i2.CodePromoStatut value,
  ) => _i1.ColumnValue(
    table.statut,
    value,
  );
...
class CodePromoTable extends _i1.Table<int?> {
  CodePromoTable({super.tableRelation}) : super(tableName: 'code_promo') {
    updateTable = CodePromoUpdateTable(this);
    code = _i1.ColumnString(
      'code',
      this,
    );
    pourcentage = _i1.ColumnDouble(
      'pourcentage',
      this,
    );
  ...
  late final _i1.ColumnDouble pourcentage;

  late final _i1.ColumnDateTime dateDebut;

  late final _i1.ColumnDateTime dateFin;

  late final _i1.ColumnEnum<_i2.CodePromoStatut> statut;
