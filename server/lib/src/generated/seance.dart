...
import 'seance_statut.dart' as _i2;
...
abstract class Seance implements _i1.TableRow<int?>, _i1.ProtocolSerialization {
  ...
  factory Seance({
    ...
    required _i2.SeanceStatut type,
  }) = _SeanceImpl;
  ...
  factory Seance.fromJson(Map<String, dynamic> jsonSerialization) {
    return Seance(
      ...
      type: _i2.SeanceStatut.fromJson((jsonSerialization['type'] as String)),
    );
  }
...
class SeanceUpdateTable extends _i1.UpdateTable<SeanceTable> {
  ...
  _i1.ColumnValue<_i2.SeanceStatut, _i2.SeanceStatut> type(
    _i2.SeanceStatut value,
  ) => _i1.ColumnValue(
    table.type,
    value,
  );
...
class SeanceTable extends _i1.Table<int?> {
  ...
  late final _i1.ColumnEnum<_i2.SeanceStatut> type;
