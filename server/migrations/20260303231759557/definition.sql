...
-- Indexes
CREATE INDEX "idx_seances_film" ON "seances" USING btree ("film_id");
CREATE INDEX "idx_seances_salle" ON "seances" USING btree ("salle_id");
CREATE INDEX "idx_seances_date" ON "seances" USING btree ("date_heure");
