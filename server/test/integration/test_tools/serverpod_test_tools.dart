...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:cinema_reservation_server/src/generated/films/film.dart' as _i5;
import 'package:cinema_reservation_server/src/generated/greetings/greeting.dart'
    as _i6;
import 'package:cinema_reservation_server/src/generated/protocol.dart';
import 'package:cinema_reservation_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _AdminDashboardEndpoint adminDashboard;

  late final _AdminFilmsEndpoint adminFilms;

  late final _AdminReservationsEndpoint adminReservations;

  late final _AdminSallesEndpoint adminSalles;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    adminDashboard = _AdminDashboardEndpoint(
      endpoints,
      serializationManager,
    );
    adminFilms = _AdminFilmsEndpoint(
      endpoints,
      serializationManager,
    );
    adminReservations = _AdminReservationsEndpoint(
      endpoints,
      serializationManager,
    );
    adminSalles = _AdminSallesEndpoint(
      endpoints,
      serializationManager,
    );
...
class _AdminDashboardEndpoint {
  _AdminDashboardEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<String> getDashboardStats(
    _i1.TestSessionBuilder sessionBuilder,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
...
class _AdminFilmsEndpoint {
  ...
  _i3.Future<_i5.Film> createFilm(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.Film film,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          parameters: _i1.testObjectToJson({'film': film}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
  ...
  _i3.Future<_i5.Film> updateFilm(
    _i1.TestSessionBuilder sessionBuilder,
    _i5.Film film,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _AdminReservationsEndpoint {
  _AdminReservationsEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<List<String>> getReservations(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminReservations',
  ...
  _i3.Future<bool> annulerReservation(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<bool> effectuerRemboursement(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminReservations',
            method: 'effectuerRemboursement',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminReservations',
          methodName: 'effectuerRemboursement',
          parameters: _i1.testObjectToJson({'id': id}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _AdminSallesEndpoint {
  _AdminSallesEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<List<String>> getSalles(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminSalles',
            method: 'getSalles',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminSalles',
...
class _AdminSeancesEndpoint {
  _AdminSeancesEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _i3.Future<List<String>> getFilmsDisponibles(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminSeances',
            method: 'getFilmsDisponibles',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminSeances',
          methodName: 'getFilmsDisponibles',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<List<String>> getSallesDisponibles(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminSeances',
            method: 'getSallesDisponibles',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminSeances',
          methodName: 'getSallesDisponibles',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _AdminUsersEndpoint {
  ...
  _i3.Future<bool> changerStatutUtilisateur(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminUsers',
            method: 'changerStatutUtilisateur',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminUsers',
          methodName: 'changerStatutUtilisateur',
          parameters: _i1.testObjectToJson({
            'id': id,
  ...
  _i3.Future<bool> supprimerUtilisateur(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminUsers',
          methodName: 'supprimerUtilisateur',
          parameters: _i1.testObjectToJson({'id': id}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
  ...
  _i3.Future<List<String>> getHistoriqueAchats(
    _i1.TestSessionBuilder sessionBuilder,
    int utilisateurId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminUsers',
            method: 'getHistoriqueAchats',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminUsers',
          methodName: 'getHistoriqueAchats',
          parameters: _i1.testObjectToJson({'utilisateurId': utilisateurId}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
            await (_localCallContext.method.call(
